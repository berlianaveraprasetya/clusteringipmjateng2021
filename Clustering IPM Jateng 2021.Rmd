...
##Nah dari sini keliatan kl k-means clustering memberikan performa yang paling baik, 
##dilihat dari nilai average silhouette yang termasuk tinggi diantara metode clustering lain. 
##Jadi lanjut pake clustering KMeans, kita ambil Jumlah klaster yang digunakan adalah 4, 
##dengan melihat sisi kemudahan interpretasi dan nilai average silhouette. 
##Semakin banyak jumlah klaster maka akan semakin sulit melakukan interpretasi, 
##begitu juga dengan semakin sedikit jumlah klaster maka akan semakin tidak terpetakan dengan baik kesamaan karakteristiknya.
